...
import { useMyBadgeCount, useMyTotalProfit } from '@/features/badges/hooks/useBadges';
...
export function UserMenu() {
  ...
  const { data: totalProfit }   = useMyTotalProfit();
  const rank = totalProfit != null ? getUserRank(totalProfit) : null;
